...
static uint16_t	_gain;
static uint16_t	_mux;
...
*/
/**************************************************************************/
void ADS1115::begin(uint8_t i2cAddress) {
	Wire.begin();
...
*/
/**************************************************************************/
void ADS1115::setMux(uint16_t mux) {
	_mux = mux;
}
/**************************************************************************/
/*!
...
*/
/**************************************************************************/
void ADS1115::setSampleRate(uint8_t rate) {
	_rate = rate;
}
/**************************************************************************/
/*! 
